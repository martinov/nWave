...
Load skill files on-demand by phase. Read the files from this directory as needed.

| Skill | File | Description |
|-------|------|-------------|
| bdd-requirements | bdd-requirements.md | BDD requirements discovery methodology - Example Mapping, Three Amigos, conversa... |
| design-methodology | design-methodology.md | Apple LeanUX++ design workflow, journey schema, emotional arc patterns, and CLI ... |
| discovery-methodology | discovery-methodology.md | Question-first approach to understanding user journeys. Load when starting a new... |
| jtbd-bdd-integration | jtbd-bdd-integration.md | Translating JTBD analysis to BDD scenarios - job story to Given-When-Then patter... |
| jtbd-core | jtbd-core.md | Core JTBD theory and job story format - job dimensions, job story template, job ... |
| jtbd-interviews | jtbd-interviews.md | JTBD discovery techniques adapted for AI product owner context. Four Forces extr... |
...
| ux-tui-patterns | ux-tui-patterns.md | Terminal UI and CLI design patterns for product owners. Load when designing comm... |
| ux-web-patterns | ux-web-patterns.md | Web UI design patterns for product owners. Load when designing web application i... |
