...
Commands:
  ...
  python3 -m des.adapters.drivers.hooks.claude_code_hook_adapter session-start
  python3 -m des.adapters.drivers.hooks.claude_code_hook_adapter subagent-start
