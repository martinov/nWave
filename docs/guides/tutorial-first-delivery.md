...
|------|-------------|-------|
| DISCUSS | Requirements gathering with AI product owner | [Tutorial: DISCUSS wave](./tutorial-discuss.md) |
| DESIGN | Architecture decisions with AI solution architect | [Tutorial: DESIGN wave](./tutorial-design.md) |
| DEVOPS | Infrastructure readiness with AI platform architect | [Tutorial: DEVOPS wave](./tutorial-devops.md) |
| DISTILL | Auto-generate acceptance tests from requirements | [Tutorial: DISTILL wave](./tutorial-distill.md) |
