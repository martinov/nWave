...
For detailed explanation of the model, see [Understanding the SSOT Model](understanding-ssot-model.md).

For directory reference, see [Wave Directory Structure](wave-directory-structure.md).
