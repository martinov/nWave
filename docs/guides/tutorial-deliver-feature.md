...
This takes 3-5 minutes for the domain steps. Each step follows the cycle you learned in [Tutorial 3](./tutorial-delivery-pipeline.md): RED (test fails), GREEN (minimum code to pass), COMMIT.
...
The reviewer checks the same seven dimensions described in [Tutorial 3](./tutorial-delivery-pipeline.md). The ones most relevant here:
