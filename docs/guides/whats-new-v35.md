...
See the [DIVERGE Wave Guide](diverge-wave-guide.md) for details.
...
See [Understanding the SSOT Model](understanding-ssot-model.md) for the full explanation, or [Migrating to the SSOT Model](migrating-to-ssot-model.md) for the step-by-step upgrade guide.
...
DISTILL → DELIVER is always the terminal pair. See [Wave Routing Guide](wave-routing-and-entry-points.md).
